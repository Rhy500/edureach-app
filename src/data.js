export const SUBJECTS = [
  { id: "semua", label: "Semua", icon: "◈", color: "bg-gray-100 text-gray-700" },
...
export const COURSES = [
  { id: 1, title: "Aljabar dasar untuk pemula", subject: "matematika", level: "SMP", episodes: 5, duration: "38 mnt", progress: 60, isNew: false },
  { id: 2, title: "Sistem tata surya & planet", subject: "ipa", level: "SMP", episodes: 4, duration: "29 mnt", progress: 25, isNew: false },
  { id: 3, title: "Pengenalan Python untuk pemula", subject: "coding", level: "SMA", episodes: 6, duration: "51 mnt", progress: 5, isNew: true },
  { id: 4, title: "Internet sehat & keamanan digital", subject: "digital", level: "SMP", episodes: 4, duration: "22 mnt", progress: 100, isNew: false },
  ...
  { id: 9, title: "Teks narasi & cerita pendek", subject: "bahasa", level: "SMP", episodes: 4, duration: "28 mnt", progress: 80, isNew: false },
...
export const EPISODES = [
  { id: 1, num: 1, title: "Apa itu variabel?", duration: "5:10", done: true },
  { id: 2, num: 2, title: "Operasi dasar aljabar", duration: "6:33", done: true },
  { id: 3, num: 3, title: "Persamaan linear satu variabel", duration: "7:42", done: false, active: true },
  { id: 4, num: 4, title: "Latihan soal bersama", duration: "9:05", done: false },
  { id: 5, num: 5, title: "Kuis & penutup", duration: "4:20", done: false },
];
...
export const QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    options: ["Angka tetap yang diketahui", "Simbol yang mewakili nilai tidak diketahui", "Hasil dari persamaan", "Operasi matematika"],
    correct: 1,
...
export const MENTORS = [
  {
    ...
    rating: 4.9,
    courses: 8,
    bio: "Guru SMA dengan 10 tahun pengalaman. Spesialis aljabar dan kalkulus dasar. Senang membuat matematika jadi mudah dipahami.",
  ...
  },
  {
    ...
    rating: 4.9,
    courses: 12,
    bio: "Software engineer di startup teknologi. Mengajar coding sejak kuliah. Percaya semua orang bisa belajar pemrograman.",
  ...
  },
  {
    ...
    rating: 4.7,
    courses: 4,
    bio: "Konsultan keamanan digital dan edukator teknologi. Fokus pada internet sehat dan kesadaran AI untuk remaja.",
    badges: ["Baru", "Aktif"],
  },
];